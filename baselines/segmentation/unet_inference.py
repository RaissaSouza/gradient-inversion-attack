...
# Load best model
model.load_state_dict(torch.load("unet_skip_model_seg.pt", map_location=device))
model.eval()
...
results_df.to_csv("unet_skip_test_results.csv", index=False)
...
print("Per-image results saved to unet_skip_test_results.csv")
